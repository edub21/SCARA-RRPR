...
bool avig_msg__msg__obj_detect__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("avig_msg.msg._obj_detect.ObjDetect", full_classname_dest, 34) == 0);
  }
  avig_msg__msg__ObjDetect * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of ObjDetect */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("avig_msg.msg._obj_detect");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ObjDetect");
