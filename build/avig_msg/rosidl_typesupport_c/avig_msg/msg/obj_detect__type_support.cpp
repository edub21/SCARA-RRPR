...
static const _ObjDetect_type_support_symbol_names_t _ObjDetect_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, avig_msg, msg, ObjDetect)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, avig_msg, msg, ObjDetect)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, avig_msg, msg, ObjDetect)() {
  return &::avig_msg::msg::rosidl_typesupport_c::ObjDetect_message_type_support_handle;
}
