...
static const _Heuristica_Request_type_support_symbol_names_t _Heuristica_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, avig_msg, srv, Heuristica_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, avig_msg, srv, Heuristica_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, avig_msg, srv, Heuristica_Request)() {
  return &::avig_msg::srv::rosidl_typesupport_c::Heuristica_Request_message_type_support_handle;
}
...
static const _Heuristica_Response_type_support_symbol_names_t _Heuristica_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, avig_msg, srv, Heuristica_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, avig_msg, srv, Heuristica_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, avig_msg, srv, Heuristica_Response)() {
  return &::avig_msg::srv::rosidl_typesupport_c::Heuristica_Response_message_type_support_handle;
}
...
static const _Heuristica_type_support_symbol_names_t _Heuristica_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, avig_msg, srv, Heuristica)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, avig_msg, srv, Heuristica)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, avig_msg, srv, Heuristica)() {
  return &::avig_msg::srv::rosidl_typesupport_c::Heuristica_service_type_support_handle;
}
