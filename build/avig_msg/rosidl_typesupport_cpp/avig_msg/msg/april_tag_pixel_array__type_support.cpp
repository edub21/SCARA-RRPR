...
static const _AprilTagPixelArray_type_support_symbol_names_t _AprilTagPixelArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, avig_msg, msg, AprilTagPixelArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, avig_msg, msg, AprilTagPixelArray)),
  }
};
...
{
  return &::avig_msg::msg::rosidl_typesupport_cpp::AprilTagPixelArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, avig_msg, msg, AprilTagPixelArray)() {
  return get_message_type_support_handle<avig_msg::msg::AprilTagPixelArray>();
}
