...
#include "avig_msg/msg/detail/april_tag_pixel__rosidl_typesupport_fastrtps_c.h"
...
using _AprilTagPixel__ros_msg_type = avig_msg__msg__AprilTagPixel;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AprilTagPixel__ros_msg_type * ros_message = static_cast<const _AprilTagPixel__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr << ros_message->id;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _AprilTagPixel__ros_msg_type * ros_message = static_cast<_AprilTagPixel__ros_msg_type *>(untyped_ros_message);
  // Field name: id
  {
    cdr >> ros_message->id;
  }
...
static uint32_t _AprilTagPixel__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_avig_msg__msg__AprilTagPixel(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = avig_msg__msg__AprilTagPixel;
    is_plain =
      (
...
static size_t _AprilTagPixel__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_avig_msg__msg__AprilTagPixel(
...
static message_type_support_callbacks_t __callbacks_AprilTagPixel = {
  "avig_msg::msg",
  "AprilTagPixel",
