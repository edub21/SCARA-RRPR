...
#include "avig_msg/msg/detail/obj_detect__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = avig_msg::msg::ObjDetect;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const avig_msg::msg::ObjDetect *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<avig_msg::msg::ObjDetect *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ObjDetect__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const avig_msg::msg::ObjDetect *>(
...
static size_t _ObjDetect__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ObjDetect(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ObjDetect__callbacks = {
  "avig_msg::msg",
  "ObjDetect",
...
static rosidl_message_type_support_t _ObjDetect__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ObjDetect__callbacks,
...
{
  return &avig_msg::msg::typesupport_fastrtps_cpp::_ObjDetect__handle;
}
